...
package com.example.reserved.column.filter.demo.service.persistence;
...
public class FooUtil {
	...
	public static Foo findByUuid_First(
		...
		throws com.example.reserved.column.filter.demo.exception.
			NoSuchFooException {
