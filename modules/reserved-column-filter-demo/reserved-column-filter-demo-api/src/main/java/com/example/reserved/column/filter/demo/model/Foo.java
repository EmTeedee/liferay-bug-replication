...
@ImplementationClassName(
	"com.example.reserved.column.filter.demo.model.impl.FooImpl"
)
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>com.example.reserved.column.filter.demo.model.impl.FooImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
