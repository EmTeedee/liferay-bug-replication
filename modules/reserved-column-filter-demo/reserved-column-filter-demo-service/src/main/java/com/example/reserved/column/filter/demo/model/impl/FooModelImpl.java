...
import com.example.reserved.column.filter.demo.model.FooModel;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"field5", Types.VARCHAR}, {"type_", Types.VARCHAR}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table FOO_Foo (uuid_ VARCHAR(75) null,fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null,type_ VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table FOO_Foo";

	public static final String ORDER_BY_JPQL = " ORDER BY foo.type ASC";

	public static final String ORDER_BY_SQL = " ORDER BY FOO_Foo.type_ ASC";
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("type", Foo::getType);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"type", (BiConsumer<Foo, String>)Foo::setType);
	...
	public Foo cloneWithOriginalValues() {
		...
		fooImpl.setType(this.<String>getColumnOriginalValue("type_"));
	...
	public int compareTo(Foo foo) {
		...
		value = getType().compareTo(foo.getType());
	...
	public CacheModel<Foo> toCacheModel() {
		...
		fooCacheModel.type = getType();

		String type = fooCacheModel.type;

		if ((type != null) && (type.length() == 0)) {
			fooCacheModel.type = null;
		}
